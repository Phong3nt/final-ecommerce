...
| ------- | ------------------- | ------------------------------------------------------ | -------------------------------------- | -------------------------------------------- | -------- | ------ | ----------- | ------- | ----------------- |
| IMP-001 | `[UIUX_MODE]`       | Bento Grid layout for catalog & category page          | PC-001                                 | Product Catalog                              | 3        | 3      | Not Started | —       |                   |
| IMP-002 | `[UIUX_MODE]`       | Skeleton Screen for all async-load areas               | PC-001, AD-001, AD-002                 | Product Catalog · Admin                      | 3        | 3      | Not Started | —       |                   |
| IMP-003 | `[FULL_STACK_MODE]` | One-Page Checkout (collapse multi-step to single view) | CP-001, CP-002, CP-003                 | Checkout & Payment                           | 2        | 5      | Not Started | —       |                   |
| IMP-004 | `[FULL_STACK_MODE]` | Guest Checkout (complete order without login)          | CP-001, SC-001                         | Checkout & Payment                           | 2        | 5      | Not Started | —       |                   |
| IMP-005 | `[UIUX_MODE]`       | Off-canvas cart drawer (mobile-first slide-in)         | SC-001, SC-002                         | Shopping Cart                                | 3        | 2      | Not Started | —       |                   |
| IMP-006 | `[LOGIC_MODE]`      | Eliminate N+1 queries via eager-loading                | PC-001, OH-001, OH-002, OM-001, OM-002 | Product Catalog · Order History · Order Mgmt | 2        | 3      | Not Started | —       |                   |
| IMP-007 | `[UIUX_MODE]`       | Alpine.js micro-interactions on all cart actions       | SC-001, SC-002, SC-003, SC-004         | Shopping Cart                                | 3        | 2      | Not Started | —       |                   |
| IMP-008 | `[INFRA_MODE]`      | Switch queue driver from sync to database              | CP-004, NT-001, NT-002                 | Notifications · Checkout                     | 2        | 2      | Not Started | —       |                   |
| IMP-009 | `[UIUX_MODE]`       | Global toast notification system (replace bare flash)  | AU-001–004, SC-001–004, CP-005         | Cross-cutting                                | 2        | 3      | Not Started | —       |                   |
| IMP-010 | `[UIUX_MODE]`       | Product image lightbox + zoom on detail page           | PC-005                                 | Product Catalog                              | 3        | 2      | Not Started | —       |                   |
| IMP-011 | `[UIUX_MODE]`       | Order status visual progress stepper                   | OH-003                                 | Order History                                | 3        | 2      | Not Started | —       |                   |
| IMP-012 | `[UIUX_MODE]`       | Interactive star rating input (Alpine.js, no reload)   | RV-001, RV-002                         | Product Reviews                              | 3        | 2      | Not Started | —       |                   |
| IMP-013 | `[UIUX_MODE]`       | Admin tables: sortable columns + responsive layout     | OM-001, PM-001, UM-001                 | Admin (Order/Product/User Mgmt)              | 2        | 3      | Not Started | —       |                   |
| IMP-014 | `[LOGIC_MODE]`      | Product catalog response caching (Laravel Cache)       | PC-001, PC-002, PC-003, PC-004         | Product Catalog                              | 2        | 3      | Not Started | —       |                   |
| IMP-015 | `[LOGIC_MODE]`      | DB-backed cart persistence for authenticated users     | SC-001, SC-002, SC-003, SC-004         | Shopping Cart                                | 2        | 5      | Not Started | —       |                   |
| IMP-016 | `[FULL_STACK_MODE]` | Consolidated audit log (auth events + admin actions)   | AU-002, AU-003, AU-004, PM-002, UM-004 | Auth · Admin                                 | 2        | 5      | Not Started | —       |                   |
