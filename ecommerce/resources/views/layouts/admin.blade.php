...
<head>
    ...
    <style>
        /* ── Global base ─────────────────────────────────── */
        body { font-family: 'Inter', sans-serif; font-size: 0.9375rem; background: #f1f5f9; }
        ...
        @media (max-width: 991.98px) {
            #adminSidebar { transform: translateX(-100%); transition: transform .25s ease; }
