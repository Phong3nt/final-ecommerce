    ...
    <div x-data x-init="$el.classList.add('fade-in')">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-7 col-xl-6" x-data="{
                ...
                {{-- Add Card Modal (IMP-041: teleported to

                <body> so position:fixed escapes
                    any CSS-transformed ancestor; x-effect locks body scroll while open) --}}
                    <template x-teleport="body">
                        <div x-show="open" class="modal d-block" tabindex="-1"
                            style="background:rgba(0,0,0,.5);z-index:1060;" @keydown.escape.window="open = false"
