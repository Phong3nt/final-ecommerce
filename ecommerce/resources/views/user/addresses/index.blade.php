...
<head>
    ...
    <style>
        ...
        .card { background: #fff; border: 1px solid #dee2e6; border-radius: 6px; padding: 1rem 1.25rem; margin-bottom: 1rem; }
        .card h2 { font-size: 1rem; margin: 0 0 .5rem; }
        .badge-default { background: #d1e7dd; color: #0f5132; padding: .15rem .5rem; border-radius: 10px; font-size: .78rem; font-weight: 600; }
        address { font-style: normal; line-height: 1.7; font-size: .9rem; }
        .actions { margin-top: .6rem; display: flex; gap: .5rem; flex-wrap: wrap; }
        .btn { display: inline-block; padding: .35rem .8rem; border: none; border-radius: 4px; cursor: pointer; font-size: .85rem; text-decoration: none; }
        ...
        .errors ul { color: #842029; padding-left: 1.2rem; }
        fieldset { border: 1px solid #dee2e6; border-radius: 6px; padding: 1rem; }
        legend { font-weight: 600; padding: 0 .5rem; }
        label { display: block; font-size: .875rem; margin-bottom: .2rem; margin-top: .6rem; }
        input[type=text] { width: 100%; padding: .4rem .6rem; border: 1px solid #ced4da; border-radius: 4px; font-size: .875rem; box-sizing: border-box; }
...
<body>
    ...
    <a href="{{ route('profile.show') }}" class="btn btn-secondary" style="margin-bottom:1rem;">&larr; Back to Profile</a>
