...
<div x-data x-init="$el.classList.add('fade-in')">
            ...
            <div class="card border-0 shadow-sm h-100 card-hover">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-auto">
                        ...
                        <a href="{{ route('products.search', ['q' => 'headphones']) }}" class="btn btn-primary btn-sm">Shop</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm h-100 card-hover">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-auto">
                        ...
                        <a href="{{ route('products.search', ['q' => 'watch']) }}" class="btn btn-primary btn-sm">Shop</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm h-100 card-hover">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-auto">
                        ...
                        <a href="{{ route('products.search', ['q' => 'lamp']) }}" class="btn btn-primary btn-sm">Shop</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm h-100 card-hover">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-auto">
                        ...
                        <a href="{{ route('products.search', ['q' => 'shoes']) }}" class="btn btn-primary btn-sm">Shop</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <div class="row g-4 text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted small mb-0">Every product is reviewed by real customers. Only the best make our catalog.</p>
                </div>
                <div class="col-md-4">
                    <i class="bi bi-lightning-charge-fill text-primary fs-2 mb-2"></i>
                    <h6 class="fw-semibold">Fast Delivery</h6>
                    <p class="text-muted small mb-0">Order today, receive in days. Express shipping available at checkout.</p>
                </div>
                <div class="col-md-4">
                    <i class="bi bi-patch-check-fill text-success fs-2 mb-2"></i>
                    <h6 class="fw-semibold">Quality Guaranteed</h6>
                    <p class="text-muted small mb-0">Not happy? We will make it right. Our 30-day return policy has you covered.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="imp028-promo p-4 p-md-5 mb-4 text-center">
        ...
        <p class="mb-4 opacity-75">Join thousands of happy customers. Create your free account and get access to exclusive deals.</p>
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="{{ route('products.index') }}"
